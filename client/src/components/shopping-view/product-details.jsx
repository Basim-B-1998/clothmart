        ...
        <DialogContent className="grid grid-cols-2 gap-8 sm:p-12 max-w-[90vw] sm:max-w-[80vw] lg:max-w-[70vw]">
          ...
          <div>
            <div>
              ...
              <p className="text-muted-foreground text-2xl mb-4 mt-4">{productDetails?.description}</p>
            </div>
              ...
              <div className="mt-5 mb-5">
                {
                  ...
                  <Button className="w-full text-black" onClick={()=>handleAddtoCart   (productDetails?._id,productDetails?.totalStock)}>Add to cart</Button>
                }
                </div>
                <Separator/>
                <div className="max-h-[300px] overflow-auto">
                    ...
                    <div className="mt-10 flex-col flex gap-2">
                      ...
                      <Input name="reviewMsg" value={reviewMsg} onChange={(event)=>setReviewMsg(event.target.value)} placeholder="Write a review..."></Input>
                       <Button className="text-black" onClick={handleAddReview} disabled={reviewMsg.trim() === ""}>submit</Button>
                    </div>
                </div>
             </div>
